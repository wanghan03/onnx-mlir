...
#include "src/Transform/ONNX/GeluSuperApproximate.inc"
struct GeluSuperApproximatePass
    : public PassWrapper<GeluSuperApproximatePass, FunctionPass> {
  void runOnFunction() final;
};
} // end anonymous namespace.

void GeluSuperApproximatePass::runOnFunction() {
 ...
 */
std::unique_ptr<mlir::Pass> mlir::createGeluSuperApproximatePass() {
  return std::make_unique<GeluSuperApproximatePass>();
}
