...
#include "src/Transform/ONNX/GeluCombine.inc"
struct GeluCombinePass
    : public PassWrapper<GeluCombinePass, FunctionPass> {
  void runOnFunction() final;
};
} // end anonymous namespace.

void GeluCombinePass::runOnFunction() {
 ...
 */
std::unique_ptr<mlir::Pass> mlir::createGeluCombinePass() {
  return std::make_unique<GeluCombinePass>();
}
